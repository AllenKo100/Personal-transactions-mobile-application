...
public class WSTransactionAddPostInteractor extends AsyncTask<String, Integer, Void> {
    ...
    public WSTransactionAddPostInteractor(TransactionListPresenter caller) {
        this.caller = caller;
        this.transaction = new Transaction();
    }

    public WSTransactionAddPostInteractor(TransactionListPresenter caller, Transaction transaction) {
        this.caller = caller;
        this.transaction = transaction;
    }

    public WSTransactionAddPostInteractor(ConnectivityBroadcastReceiver caller, Transaction transaction) {
        this.caller2 = caller;
        this.transaction = transaction;
    }
    ...
    protected Void doInBackground(String... strings) {
        try {
            String url1 = root + "account/" + api_id + "/transactions";
    ...
    protected void onPostExecute(Void aVoid) {
        ...
        if(caller == null) caller2.onAddDone(transaction);
        else caller.onAddDone(transaction);
    }
